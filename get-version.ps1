# get-version.ps1 - View or checkout a previous version of hta-schema
...
Write-Host "=== HTA Schema: Version History ===" -ForegroundColor Cyan
...
if (-not $Version) {
    ...
    Write-Host "  .\get-version.ps1 v0.1.0              # View version details"
    Write-Host "  .\get-version.ps1 v0.1.0 -Checkout    # Checkout this version"
